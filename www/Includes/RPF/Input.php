...
class RPF_Input
{
	...
	* Constructor
	*
	* @param array $source Source of input
	*/
	...
	*/
	...
	protected static function _doClean($filterName, array $filterOptions, $data, $defaultData)
	{
		switch ($filterName)
		{
			...
			default:
				throw new Exception("Unknown input type in " . __CLASS__ . "::" . __METHOD__);
		}
		return $data;
	}
	...
	*
	* @param array	Key-value pairs with the value being in the format expected by filterSingle. 
	*
